...
class AutoSubmitModelUpdateTestCase(unittest.TestCase):
    ...
    def test_auto_submit_model_update_fail_5(self):
        # TODO : Add test key below
        #   NOTE: Test key should only work on a SANDBOX implementation in the cloud
        client = FedLearnApi("uh_idk_what_to_put_here_yet")
        ...
        self.assertRaises(FedLearnApiException, client.auto_submit_model_update, "testingsdfsdf", group.get_id(), learning_round.get_id(), device.get_id())
