...
class UT_GetInitialGroupModelSubmitLinkTestCase(unittest.TestCase):
    ...
    def test_fail_invalid_group_id_2(self):
        ...
        self.assertRaises(FedLearnApiException, client.get_initial_group_model_submit_link, 12462)
