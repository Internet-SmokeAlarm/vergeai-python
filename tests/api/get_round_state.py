...
class GetRoundStateTestCase(unittest.TestCase):

    def test_get_round_state_pass(self):
    ...
    def test_get_round_state_fail_invalid_group_id(self):
        # TODO : Add test key below
        #   NOTE: Test key should only work on a SANDBOX implementation in the cloud
        client = FedLearnApi("uh_idk_what_to_put_here_yet")
        group = client.create_group("sim_test_group")
        ...
        learning_round = client.start_round(group.get_id())
        self.assertRaises(FedLearnApiException, client.get_round_state, None, learning_round.get_id())

        client.delete_group(group.get_id())

    def test_get_round_state_fail_invalid_round_id(self):
        # TODO : Add test key below
        #   NOTE: Test key should only work on a SANDBOX implementation in the cloud
        client = FedLearnApi("uh_idk_what_to_put_here_yet")
        group = client.create_group("sim_test_group")
        ...
        learning_round = client.start_round(group.get_id())
        self.assertRaises(FedLearnApiException, client.get_round_state, group.get_id(), None)

        client.delete_group(group.get_id())

    def test_get_round_state_fail_nonexistant_round_id(self):
        # TODO : Add test key below
        #   NOTE: Test key should only work on a SANDBOX implementation in the cloud
        client = FedLearnApi("uh_idk_what_to_put_here_yet")
        group = client.create_group("sim_test_group")
